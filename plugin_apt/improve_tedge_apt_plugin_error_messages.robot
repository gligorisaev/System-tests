#Command to execute:    robot -d \results --timestampoutputs --log improve_tedge_apt_plugin_error_messages.html --report NONE --variable VERSION:0.7.4 --variable HOST:192.168.1.130 improve_tedge_apt_plugin_error_messages.robot
*** Settings ***
Library    Browser
