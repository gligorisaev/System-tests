#Command to execute:    robot -d \results --timestampoutputs --log health_c8y-log-plugin.html --report NONE --variable HOST:192.168.1.120 health_c8y-log-plugin.robot
